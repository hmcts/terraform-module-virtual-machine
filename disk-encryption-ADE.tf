...
resource "azurerm_virtual_machine_extension" "vmextension" {
  ...
  depends_on = [azurerm_windows_virtual_machine.winvm, azurerm_linux_virtual_machine.linvm, azurerm_virtual_machine_data_disk_attachment.data_disk_attachments, azurerm_key_vault_key.disk_enc_key, module.vm-bootstrap]
}
